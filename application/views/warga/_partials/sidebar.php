<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="https://adminlte.io/docs"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/charts/chartjs.html"><i class="fa fa-circle-o"></i> Data RT</a></li>
            <li><a href="pages/charts/morris.html"><i class="fa fa-circle-o"></i> Data Warga</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
